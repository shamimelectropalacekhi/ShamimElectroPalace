...
export async function generateMetadata({ params }) {
  ...
  return { title: `${product.name} - ${product.brand}`, description: product.description, openGraph: { images: [product.image] } }
}
...
export default async function ProductPage({ params }) {
  ...
  const jsonLd = product && {
    '@context': 'https://schema.org', '@type': 'Product', name: product.name, description: product.description, image: product.image,
